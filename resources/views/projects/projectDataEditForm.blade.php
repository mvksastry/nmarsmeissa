  <div class="card-body">
    ...
    <div class="form-group">
      ...
      value="{{ $tempproject->title }}" placeholder="Project Title">
        @if($errors->has('title'))
          <p class="text-danger">
          {{ $errors->first('title') }}
          </p>
    ...
    <div class="form-group">
      ...
      value="{{ $tempproject->start_date }}" placeholder="Start Date">
    ...
    <div class="form-group">
      ...
      value="{{ $tempproject->end_date }}" placeholder="End Date">
    </div>
