	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Home: Reorganize</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
							<li class="breadcrumb-item active">Reorganize</li>
						</ol>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.container-fluid -->
						  ...
						  <div class="card-body">
							<div class="tab-content p-0">
								...
								<div class="chart tab-pane active" id="revenue-chart" style="position: relative;">
									...
									@if($rackUpdate)
                    @include('livewire.reorganize.rackInfos')
                  @endif
		...
		<section class="content">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  @if($layoutRack)
                    @include('livewire.reorganize.cageLocationLayout')
                  @endif
