      ...
      <div class="flex flex-row flex-wrap flex-grow mt-2">
          ...
          <div class="bg-gray-900 border border-gray-800 rounded shadow">
            ...
            <div class="border-b border-gray-800 p-3">
              <h5 class="font-bold uppercase text-yellow-600">Add New Building</h5>
            </div>
            ...
            <div class="w-2/4 p-5">
							{!! Form::open(['method' => 'POST', 'route' => ['roomsnracks.store']]) !!}
								...
								<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline" value="" id="name" name="name" type="text" placeholder="Name">
