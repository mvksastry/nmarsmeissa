				...
				<div class="row">
                    ...
                    -->
                          ...
                          <input type="text" hidden class="form-control form-control-border" 
                            name="purpose" id="purpose" value="new" placeholder="Notes">
                          ...
                          <div class="col-xs-12 form-group">
                            ...
                            name="rack_name" id="rack_name" value="{{ old('rack_name') }}" placeholder="Rack Name">
                          ...
                          <div class="col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-border" 
                            name="rows" id="rows" value="{{ old('rows') }}" placeholder="Rows">
                            @if($errors->has('rows'))
                              <p class="help-block text-danger">
                                {{ $errors->first('rows') }}
                              </p>
                          ...
                          <div class="col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-border" 
                            name="cols" id="cols" value="{{ old('cols') }}" placeholder="Columns">
                            @if($errors->has('cols'))
                              <p class="help-block text-danger">
                                {{ $errors->first('cols') }}
                              </p>
                          ...
                          <div class="col-xs-12 form-group">
                            ...
                            <input type="text" class="form-control form-control-border" 
                            name="levels" id="levels" value="{{ old('levels') }}" placeholder="Shelfs">
